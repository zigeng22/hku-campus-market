...
| DEMO-01 | DONE | Seed demo data 或稳定测试账号方案 | INT-01 | PR #11 已于 2026-07-22 合并到 `main`（merge `30f8609`）；后续 Enhancement Round 1 扩展为 Alice/Bob/Carol/David、每人至少 2 个商品和跨用户 Offer，并为 8 个商品安装图库图片 |
...
| 账号 | 密码 | 用途 |
|---|---|---|
| `AliceDemo` | `demo123` | 卖家，WhatsApp `91234567` |
| `BobDemo` | `demo123` | 买家，WhatsApp `92345678` |
...
3. 当前 `feat/enhancement-round-1` 完成 4 账号 Demo、8 张商品图、Offer 拒绝、Sold 联系人/删除、待处理提醒和账户设置，合并前以新增强记录中的 ENH-QA-01 为验收基线。
